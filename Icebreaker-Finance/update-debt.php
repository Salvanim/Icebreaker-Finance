...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['id'], $_POST['debt_name'], $_POST['debt_amount'], $_POST['min_payment'], $_POST['interest_rate'])) {
        ...
        // Update query
        $sql = "UPDATE debts SET debt_name = :debt_name, debt_amount = :debt_amount, 
                min_payment = :min_payment, interest_rate = :interest_rate WHERE id = :id";
